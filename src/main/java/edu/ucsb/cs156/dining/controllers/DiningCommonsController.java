...
public class DiningCommonsController extends ApiController {
     ...
     */
    @Operation(summary= "List all DiningCommons")
     ...
     */
    @Operation(summary= "Get a single DiningCommons")
    @PreAuthorize("hasRole('ROLE_USER')")
    @GetMapping("")
     ...
     */
    @Operation(summary= "Create a new DiningCommons")
     ...
     */
    @Operation(summary= "Update a single DiningCommons")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PutMapping("")
